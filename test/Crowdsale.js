...
const HomelendToken = artifacts.require('HomelendToken')

contract('Crowdsale', function([_, investor, wallet, purchaser]) {
    const rate = new BigNumber(3200);
    const value = ether(3);

    const expectedTokenAmount = value;// rate.mul(value);
    ...
    beforeEach(async function() {
        ...
        this.token = await HomelendToken.new();
