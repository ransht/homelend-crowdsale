...
//compiler related:
const CONTRACT_NAME = "HomelendCrowdsale";
...
//Homelendrowdsale constructor params:
...
async function processContract(contractFilePAth) {
    ...
    HomelendCrowdsaleCompiled = copmiled.contracts[":" + CONTRACT_NAME];
    var bytecode = HomelendCrowdsaleCompiled.bytecode
    var abi = HomelendCrowdsaleCompiled.interface;
...
function deployContract() {
    ...
    new eth.Contract(JSON.parse(HomelendCrowdsaleCompiled.interface), null, {
        data: '0x' + HomelendCrowdsaleCompiled.bytecode
    })
        .deploy({
